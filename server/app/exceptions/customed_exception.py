...
class InvalidRequestException(Exception):
  def __init__(self, detail="Invalid request", error_code="BAD_REQUESTt" ):
    self.detail = detail
    self.error_code = error_code
    
    
class UnprocessibleContentException(Exception):
  def __init__(self, detail="Unprocessible content", error_code="UNPROCESSIBLE_CONTENT" ):
    self.detail = detail
    self.error_code = error_code
